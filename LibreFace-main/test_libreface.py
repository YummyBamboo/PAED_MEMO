...
detected_facial_attributes = libreface.get_facial_attributes_image(image_path = "E:\Code For Pytorch\LibreFace-main\LibreFace-main\examples\sample_disfa.png",
                                                                   temp_dir = "./temp",
                                                                   device = "cuda")
print(detected_facial_attributes)
# inference on a single image and save results in a csv file
libreface.save_facial_attributes_image(image_path = "E:\Code For Pytorch\LibreFace-main\LibreFace-main\examples\sample_disfa.png",
